...
<!-- ICONS -->
  ...
  <!--div id="cinema" class="table hidden">
    <div class="close"></div>
    <div class="table-cell">
      <iframe src="//player.vimeo.com/video/80377117?title=0&byline=0&portrait=0&badge=0&color=<?php echo $homepage->color ?>" width="800" height="450" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
    </div>
  </div-->
